...
// The Subjects for search querying the course catalog
var Subjects map[string]string = map[string]string{
...
var SubjectNames []string = []string{
	...
	"culturalidentities",
	"planning",
	"environmentresourcesandsustainability",
	"japanese",
	"arts",
	"englishformultilingualspeakers",
	"gerontology",
	"religiousstudies",
	"greek",
	"recreationandleisurestudies",
	"civilengineering",
	"commerce",
	...
	"english",
	"puremath",
	"sexualitymarriageandfamilystudies",
	"management",
	"managementsciences",
	"scienceandbusiness",
	"statistics",
	...
	"science",
	"churchmusicandworship",
	"generalengineering",
	"politicalscience",
	"eastasian",
	"finearts",
	"businessbrwilfridlaurieruniversity",
	"electricalandcomputerengineering",
	"german",
	"appliedlanguagestudies",
	"headbodyarchitecture",
	"societytechnologyandvalues",
	"university",
	"environmentalstudies",
	"optometry",
	"socialdevelopmentstudies",
	"canadianstudies",
	"medievalstudies",
	"russian",
	...
	"genderandsocialjustice",
	"italian",
	"korean",
	"mohawk",
	"professionaldevelopmentforarchitecture",
	"physics",
	"accountingfinancialmanagement",
	"geographyandenvironmentalmanagement",
	"studiesinislam",
	"humanresourcesmanagement",
	"internationalstudies",
	"combinatoricsandoptimization",
	"frenchstudies",
	"globalbusinessanddigitalarts",
	"nanotechnologyengineering",
	"peaceandconflictstudies",
	"professionaldevelopment",
	"socialworkbrsocialdevelopmentstudies",
	"artsandbusiness",
	"businessentrepreneurshipandtechnology",
	"health",
	"humanrights",
	"indigenousstudies",
	"kinesiology",
	...
	"mathematics",
	"earthsciences",
	"mathematicalbusiness",
	"visualculture",
	"appliedmathematics",
	"biology",
	"latin",
	"digitalartscommunication",
